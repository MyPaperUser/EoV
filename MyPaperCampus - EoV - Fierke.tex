...
\begin{document}
	...
	\begin{adjustwidth}{1cm}{0cm}
   	...
   	\abs In Innenräumen ist das Tragen von Mützen und Hüten ungern gesehen.
		\end{enumerate}
	\end{adjustwidth}
	...
	\paragraphen{10}{Ruhe und Ordnung}
	\abs In den Zeiten zwischen 22:00 Uhr und 06:00 Uhr sowie 13:00 Uhr und 15:00 Uhr ist im gesamten Bereich auf Ruhe zu achten.
 
 	\paragraphen{11}{Fachgerechte Müllentsorgung}
  	\abs Die Müllentsorgung erfolgt gemäß des Kreislaufwirtschaftsgesetzes.
   
   	\abs Biomüll wird gesammelt und zur Kompostierungsanlage gebracht.
    
    	\abs Schalen von Eiern werden separat und nur in kleinen Teilen entsorgt und großflächig in der Kompostierungsanlage verteilt.
     
     	\abs Vorab wird sich darüber informiert, welche Kompostierungsanlage zu benutzen ist.
      	\paragraphen{12}{Verkehrsordnung}
       	\abs Das Befahren des Mypapercampus ist grundsätzlich nicht gestattet.
	
	\abs Von § 12 Abs. 1 ausgenommen sind parkberechtigte Fahrzeuge sowie der Lieferverkehr.
 
 	\abs Parkberechtigungen werden bei der Verwaltung beantragt. Nach einer Prüfung des Antrags wird diese ausgestellt.
  
  	\paragraph{13}{Termine}
   	\abs Pünktlichkeit wird geschätzt. Pünktlich heißt, vor oder zu der Zeit des Termins anzutreten.
    
    	\abs Termine werden von der Verwaltung vergeben, sowie bei ihr beantragt.
